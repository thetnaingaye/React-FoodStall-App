    ...
    return (
        <div className="sidebar-nav">
            <ul className="nav">
                ...
                {isOwner &&<li className="nav-divider"></li>}
                {isOwner &&
                <li>
                    <NavLink to='/Summary/grid' className="btn btn-warning btn-lg" style={{ textAlign: "left", backgroundColor: "orange" }} ><span style={{ paddingRight: "15px" }} className="glyphicon glyphicon-th-list"></span>ALL aORDERS</NavLink>
                </li>
                }
            </ul>
        </div>
